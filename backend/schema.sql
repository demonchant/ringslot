...
CREATE INDEX IF NOT EXISTS idx_provider_services_key ON provider_services(provider_name, service_key);
...
-- Public contact form submissions. These are separate from authenticated
-- support tickets so visitors can ask pre-sale and account-access questions.
